module.exports = function(async, Place, Users){
    return {
        ...
        postResults: function(req, res){
            async.parallel([
                function(callback){
                    ...
                    Place.find({'$or': [{'country':regex}, {'name': regex}]}, (err, result) => {
                       callback(err, result); 
                    });
                }
            ], (err, results) => {
                ...
                res.render('results', {title: 'Sharing Marche - Results', user: req.user, chunks: dataChunk});
            })
        },
        ...
        viewMembers: function(req, res){
            async.parallel([
                ...
                res.render('members', {title: 'Sharing Marche - Members', user: req.user, chunks: dataChunk});
            })
        },
