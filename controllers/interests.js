    ...
    return {
        ...
        getInterestPage: function(req, res){
            async.parallel([
                ...
                res.render('user/interest', {title: 'Sharing Marche - Interests', user:req.user, data: result1, chat:result2});
            });
        },
        ...
        postInterestPage: function(req, res){
            ...
            async.parallel([
               function(callback){
                   if(req.body.favPlace){
                       Users.update({
                           '_id':req.user._id,
                           'favPlace.placeName': {$ne: req.body.favPlace}
                       },
                       {
                            $push: {favPlace: {
                                placeName: req.body.favPlace
                            }}    
                       }, (err, result1) => {
